    ...
    <table cellpadding="0" cellspacing="0" width="100%">
        ...
        <tr>
            <td align="center" class="esd-block-text es-m-txt-c">
                <h2>SOLICITUD DE CAMBIO DE CONTRASEÑA - INAGAVE</h2>
            </td>
        </tr>
        <tr>
            <td align="center" class="esd-block-text es-p20b">
                ...
                <p>
                    Para cambio de contraseña por favor visite el siguiente
                    <a target="_blank" href="https://panel.inagave.com/auth/password/reset/token/{{ $user['remember_token'] }}">enlace</a>:<br/>

                    O copie y pegue el siguiente enlace en el explorador: <br/>
                    https://panel.inagave.com/auth/password/reset/token/{{ $user['remember_token'] }}
                </p>
