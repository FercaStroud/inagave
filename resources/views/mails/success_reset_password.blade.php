    ...
    <table cellpadding="0" cellspacing="0" width="100%">
        ...
        <tr>
            <td align="center" class="esd-block-text es-m-txt-c">
                <h2>SU CONTRASEÑA HA SIDO CAMBIADA - INAGAVE</h2>
            </td>
        </tr>
        <tr>
            <td align="center" class="esd-block-text es-p20b">
                ...
                <p>
                    Se solició un cambio de contraseña, si usted no inició este proceso, favor de contactar a
                    los administradores en payments@inagave.com
                </p>
